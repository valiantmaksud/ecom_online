...
trait QueryShorter
{
    ...
    */
    ...
    /*
     ...
     |--------------------------------------------------------------------------
    */
    public function scopeDaily($query, $filed_name = 'date')
    {
        $query->where($filed_name, date('Y-m-d'));
    }
    ...
    /*
     ...
     |--------------------------------------------------------------------------
    */
    public function scopeWeekly($query, $filed_name = 'date')
    {
        $date = now()->subWeek()->format('Y-m-d');

        $query->where($filed_name, '>=', $date);
    }
    ...
    /*
     ...
     |--------------------------------------------------------------------------
    */
    public function scopeMonthly($query, $filed_name = 'date')
    {
    ...
    /*
     ...
     |--------------------------------------------------------------------------
    */
    public function scopeYearly($query, $filed_name = 'date')
    {
